...
contract LiquidityExamples in IERC721Receiver{
    ...
    // Store token id is use in this example
    uint public tokenId;
    ...
    // set the data and owner for position
    ...
    function mintNewPosition()external returns(uint _tokenId, uint128 liquidity, uint amount0, uint amount1){
        // for this example we will provide equal amount of liquidity in both assests
        // Providing liquidity in bith assests means liquidity is earning fees and is in range
        uint amount0ToMint = 100 * 1e18;
        uint amount1ToMint = 100 * 1e16;
        ...
        INonfungiblePositionManager.MintParams memory params = INonfungiblePositionManager.MintParams({
            ...
            // we are providing liquidity across the whole range of pool
